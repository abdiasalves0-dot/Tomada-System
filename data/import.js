 ...
 * Email: padeiroBancada@gmail.com / Senha: pad123
 */
async function createPadeiroUser() {
  ...
  return {
    ...
    nome: 'Padeiro Bancada (Teste)',
    cargo: 'PADEIRO PLENO',
    filial: 'Bancada Goiania',
    email: 'padeiroBancada@gmail.com',
    emailPessoal: 'padeiroBancada@gmail.com',
    emailCorporativo: '',
    telefone: '',
    cpf: '',
    rg: '',
...
async function runImport() {
  console.log('🍞 ══════════════════════════════════════════');
  console.log('   IMPORTAÇÃO DE DADOS - Bancada SISTEMA PADEIRO');
  console.log('   ══════════════════════════════════════════\n');
  ...
  console.log(`   ✅ Admin criado (email: admin@Bancada.com, senha: Admin123)`);
  ...
  console.log(`   ✅ Padeiro criado (email: padeiroBancada@gmail.com, senha: pad123)`);
  ...
  console.log(`\n   Login Padeiro: padeiroBancada@gmail.com / pad123`);
  console.log(`   Login Admin:   admin@Bancada.com / Admin123\n`);
}
