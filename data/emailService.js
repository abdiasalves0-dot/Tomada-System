/**
 * Email Service Abstraction - Bancada Sistema Padeiro
 * 
...
const FROM_EMAIL = process.env.FROM_EMAIL || 'noreply@Bancadadistribuidora.com.br';
const FROM_NAME = process.env.FROM_NAME || 'Sistema Padeiro - Bancada';
...
const emailService = {
  ...
  async sendFirstAccessEmail(to, token, baseUrl) {
    ...
    const html = `
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #1a1a2e; color: #fff; border-radius: 12px; overflow: hidden;">
        <div style="background: linear-gradient(135deg, #F59E0B, #D97706); padding: 30px; text-align: center;">
          ...
          <p style="margin: 5px 0 0; color: #1a1a2e; opacity: 0.8;">Bancada Distribuidora</p>
        </div>
        <div style="padding: 30px;">
          <h2 style="color: #F59E0B; margin-top: 0;">Bem-vindo!</h2>
          <p>Você foi cadastrado no Sistema de Gerenciamento de Padeiros da Bancada.</p>
    ...
    `;
    const text = `Bem-vindo ao Sistema Padeiro - Bancada!\n\nDefina sua senha acessando: ${resetLink}\n\nEste link expira em 24 horas.`;
