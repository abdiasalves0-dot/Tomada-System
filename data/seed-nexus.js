...
const filiais = ['Bancada Brasília', 'Bancada Goiania', 'Bancada Palmas', 'Bancada Campo Grande'];
...
async function runSeed() {
  ...
  console.log('✅ Banco de dados limpo. Inserindo dados Bancada...');
  ...
  console.log(`👑 Admin master criado: admin@Bancada.com / senha: admin`);
}
