...
- `SUPER SKIL TOMADA DESIGN/diagramacao_e_elementos.md`: Regras de Grid (2fr | 1fr), hierarquia visual, Z-pattern, ritmos de padding, status badges e botões.
- `SUPER SKIL TOMADA DESIGN/popups.md`: Padrão completo para pop-ups/modais com desfoque de fundo (`backdrop-filter: blur(4px)`) e o utilitário `Components.showModal`.
- `SUPER SKIL TOMADA DESIGN/creator_tabs.md`: Estrutura dos switchers de abas segmentados (desktop e mobile).
