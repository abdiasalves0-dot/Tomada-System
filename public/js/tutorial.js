...
const Tutorial = {
  steps: [
    {
      ...
      title: 'Bem-vindo ao Bancada!',
      content: 'Este é o seu painel principal. Aqui você tem uma visão geral do desempenho dos padeiros, atividades recentes e métricas cruciais da Bancada Distribuidora.',
      target: null
    },
    {
      route: 'filiais',
      title: 'Gerenciamento de Filiais',
      content: 'Aqui você pode visualizar e gerenciar as diferentes filiais atendidas pela Bancada. Cada filial possui seus próprios padeiros e metas específicas.',
    ...
    },
    {
      ...
      content: 'Registre e consulte as avaliações técnicas dos padeiros. Mantenha o padrão de qualidade Bancada em todas as visitas e produções.',
  ...
  finish() {
    ...
    localStorage.setItem('Bancada_tutorial_seen', 'true');
  },
