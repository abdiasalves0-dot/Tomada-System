  ...
  openSmartSchedule() {
    ...
    Components.showModal('Cronograma Inteligente', `
      <div style="margin-bottom:24px;">
        ...
        <div style="background: rgba(113, 63, 18, 0.1); border-left: 4px solid var(--primary); padding: 12px 16px; border-radius: 8px; margin-bottom: 16px; font-size: 13px;">
    ...
    `, `<button class="btn btn-secondary" onclick="Components.closeModal()">Cancelar</button>
        <button class="btn" style="background-color: #E55A2B; color: white;" onclick="Cronograma.executeSmartSchedule()" id="btn-smart-exec"><i data-lucide="sparkles"></i> Gerar ${totalNovas} Tarefas</button>`
    );
