...
async function run() {
  let sql = `-- Criando o novo banco de dados Bancada\n`;
  ...
  sql += `INSERT INTO admins (id, nome, email, passwordHash, role, filial, ativo, deletado) VALUES ('admin_nexus', 'Nexus Admin', 'admin@Bancada.com', '${adminPass}', 'admin', 'Nexus Principal', 1, 0);\n\n`;
