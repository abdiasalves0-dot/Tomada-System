...
// Rota para zerar todos os dados do sistema mantendo o usuário atual logado
router.delete('/reset-all-data', authMiddleware, adminOnly, mgmtCtrl.resetAllDatabase);
